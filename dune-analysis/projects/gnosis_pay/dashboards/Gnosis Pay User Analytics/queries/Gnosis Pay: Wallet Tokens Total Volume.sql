...
-- tags: []                 
-- parameters: []                 
-- last update: 2024-07-25 17:22:45.887901                 
-- owner: hdser                 
==========================
*/
...
tokens_volume_raw AS (
    ...
    FROM
        test_schema.git_dunesql_3334f50_transfers_gnosis_erc20_agg_hour t1
    INNER JOIN
        gnosis_gp_users t2
        ON 
...
xdai_volume_raw AS (
    ...
    FROM
        test_schema.git_dunesql_3334f50_transfers_gnosis_xdai_agg_hour t1
    INNER JOIN
        gnosis_gp_users t2
        ON 
        t2.pay_wallet = t1.wallet_address
